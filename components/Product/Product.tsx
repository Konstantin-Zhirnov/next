	...
	return (
		...
		<Card className={styles.product}>
			...
			<div className={styles.credit}>
				<span className='visualyHidden'>Кредит</span>{priceRu(product.credit)}/<span className={styles.month}>мес</span></div>
			...
			<div className={styles.rateTitle}><a href="#ref" onClick={scrollToReview}>{product.reviewCount} {declOfNum(product.reviewCount, ['отзыв', 'отзывов', 'отзывов'])}</a></div>
